...
joining the Gunnail rbf, then the Comad boards (ssmissin, airattck), the
...
having cost 98K logic cells in an earlier attempt. What is left of
`nmk16.cpp` is tharrierb (needs an M68705 core), tdragonb2 and
firehawkv.
