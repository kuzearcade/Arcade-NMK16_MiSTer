...
module video_state_top #(
	...
	video_macross2 #(
		...
		.game_powerins(1'b0), .tile_lsb(1'b0), .bg_8bpp(1'b0), .bg_code_mod12k(1'b0), .tx_xscroll(9'd0), .tx_off(1'b0), .spr_off(1'b0), .base_word_fgtile(23'd0), .base_word_bgtile(23'd0), .base_word_sprites(23'd0),
