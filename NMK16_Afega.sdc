...
# Quartus renamed them to nmk004_core:g_nmk004.nmk004 and
# nmk_prot_core:g_prot_mcu.prot_mcu, the old exact-path patterns matched
# nothing, both TLCS-90 cores silently lost their multicycle exception and
# the build went from +0.585 ns to -9.563 ns. get_registers matching
# nothing is NOT an error, so this fails silently — keep the wildcard.
