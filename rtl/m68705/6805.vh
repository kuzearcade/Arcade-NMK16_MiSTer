...
assign brlatch    = ucode_data[ 0+:1];
assign branch     = ucode_data[ 5+:1];
assign halt       = ucode_data[16+:1];
assign fetch      = ucode_data[17+:1];
assign ni         = ucode_data[26+:1];
assign wr         = ucode_data[27+:1];
assign op0inv     = ucode_data[28+:1];
assign swi        = ucode_data[29+:1];
assign stop       = ucode_data[30+:1];
